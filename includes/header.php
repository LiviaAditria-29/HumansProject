            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <div class="hidden md:flex items-center gap-1">
                        ...
                        <a href="/humansproject/admin/dashboard.php"
                        ...
                        <a href="../karyawan/index.php"
                            class="flex items-center px-4 py-2 rounded-lg <?= $isactive('karyawan/index.php') ? 'bg-indigo-600/90 shadow-md shadow-indigo-900/30 font-medium' : 'text-slate-300 hover:bg-slate-700/60 hover:text-white transition-colors' ?> text-sm">
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <a href="../task/index.php"
                            class="flex items-center px-4 py-2 rounded-lg <?= $isactive('task/index.php') ? 'bg-indigo-600/90 shadow-md shadow-indigo-900/30 font-medium' : 'text-slate-300 hover:bg-slate-700/60 hover:text-white transition-colors' ?> text-sm">
                            <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <span class="ml-2">Tugas Karyawan</span>
                        </a>

                        <!-- <a href="../karyawan/create.php"
                            class="flex items-center px-4 py-2 rounded-lg text-slate-300 hover:bg-slate-700/60 hover:text-white transition-colors text-sm">
                            <span>➕</span>
                ...
                <!-- User -->
                <?php
$namaLengkap = $user['nama_lengkap'] ?? $user['nama'] ?? $_SESSION['nama_lengkap'] ?? 'Administrator';
?>
...
<div class="flex items-center gap-3">
    ...
    <!-- Tombol menu mobile -->
    <button type="button"
        onclick="document.getElementById('mobileNavAdmin').classList.toggle('hidden'); document.getElementById('mobileNavIconOpen').classList.toggle('hidden'); document.getElementById('mobileNavIconClose').classList.toggle('hidden');"
        ...
        aria-controls="mobileNavAdmin"
        aria-expanded="false">
        <svg id="mobileNavIconOpen" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h16M4 18h16"></path></svg>
        <svg id="mobileNavIconClose" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18M6 6l12 12"></path></svg>
    </button>
            ...
            <!-- Menu mobile -->
            <div id="mobileNavAdmin" class="hidden md:hidden pb-4 space-y-1">
                ...
                <a href="../karyawan/index.php"
                    class="flex items-center px-4 py-2.5 rounded-lg <?= $isactive('karyawan/index.php') ? 'bg-indigo-600/90 shadow-md shadow-indigo-900/30 font-medium' : 'text-slate-300 hover:bg-slate-700/60 hover:text-white transition-colors' ?> text-sm">
                    <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
                    </svg>
                    <span class="ml-2">Data Karyawan</span>
                ...
                <a href="../task/index.php"
                    class="flex items-center px-4 py-2.5 rounded-lg <?= $isactive('task/index.php') ? 'bg-indigo-600/90 shadow-md shadow-indigo-900/30 font-medium' : 'text-slate-300 hover:bg-slate-700/60 hover:text-white transition-colors' ?> text-sm">
                    <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4"/>
                    </svg>
                    <span class="ml-2">Tugas Karyawan</span>
                ...
                <div class="flex items-center gap-3 px-4 pt-3 mt-2 border-t border-slate-700/60 sm:hidden">
                    ...
                    <div>
                        <p class="font-semibold text-sm leading-tight"><?= e($namaLengkap) ?></p>
